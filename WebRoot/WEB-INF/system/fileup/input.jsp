...
<body>
<form id="updateForm" action="${path}/ajax_f_add" method="post" enctype="multipart/form-data">
	<table class="table table-bordered table-hover definewidth m10"> 
        ...
        <tr>
            ...
            <td colspan="4">
            	<input type="hidden" name="fileup.FId" value="<s:property value="#session.user.UId"/>"/>
