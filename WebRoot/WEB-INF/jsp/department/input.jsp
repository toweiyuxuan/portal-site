						...
						<form class="layui-form layui-form-pane" action="">
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input maxlength="100" type="text" name="name" autocomplete="off" placeholder="请输入" class="layui-input" lay-verify="required">
								</div>
							</div>
							<div class="layui-form-item">
								<label class="layui-form-label">
		...
		<script>
			...
			layui.use("form", function() {
				...
				form.on("submit(*)", function(data) {
					...
					$.ajax({
						type: "post",
						url: "${path}/departments_add",
						data: {"departments.name":data.field.name,"departments.cover":data.field.cover,"departments.introduction":data.field.introduction,"departments.description":data.field.description},
						async: false,
						dataType: "text",
