		...
		<script>
			...
			layui.use("form", function() {
				...
				form.on("submit(*)", function(data) {
					...
					$.ajax({
						type: "post",
						url: "${path}/examples_add",
						data: {"examples.name":data.field.name,"examples.cover":data.field.cover,"examples.introduction":data.field.introduction,"examples.description":data.field.description},
						async: false,
						dataType: "text",
