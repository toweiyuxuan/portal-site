...
<body>
<form id="updateForm" action="${path}/ajax_an_update" method="post" enctype="multipart/form-data">
	<table class="table table-bordered table-hover definewidth m10"> 
        ...
        <tr>
            ...
            <td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(1)" id="id_img1" src="/LDZX<s:property value="anli.APhoto1"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			<td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(2)" id="id_img2" src="/LDZX<s:property value="anli.APhoto2"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			<td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(3)" id="id_img3" src="/LDZX<s:property value="anli.APhoto3"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			 <td></td>
        ...
        <tr>
            ...
            <td colspan="4">
            	<input type="hidden" name="anli.AId" value="<s:property value="#anli.AId"/>"/>
