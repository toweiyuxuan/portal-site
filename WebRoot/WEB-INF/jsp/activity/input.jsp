		...
		<script>
			...
			layui.use("form", function() {
				...
				form.on("submit(*)", function(data) {
					...
					$.ajax({
						type: "post",
						url: "${path}/activitys_add",
						data: {"activitys.name":data.field.name,"activitys.cover":data.field.cover,"activitys.introduction":data.field.introduction,"activitys.description":data.field.description},
						async: false,
						dataType: "text",
