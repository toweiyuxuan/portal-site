...
<body>
<form id="updateForm" action="${path}/ajax_h_update" method="post" enctype="multipart/form-data">
	<table class="table table-bordered table-hover definewidth m10"> 
        <tr>
            <td class="tableleft" width="100px">标题</td>
            <td colspan="4">
            	<s:textfield maxlength="25" id="title" name="huodong.HTitle" type="text" required="true" cssStyle="width:100%"></s:textfield>            
            </td>
        </tr>
        <tr>
            <td class="tableleft" width="100px">简介</td>
            <td colspan="4">
            	<s:textfield maxlength="80" id="word" name="huodong.HAword" type="text" required="true" cssStyle="width:100%"></s:textfield>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落一</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p1" name="huodong.HP1" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落二</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p2" name="huodong.HP2" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落三</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p3" name="huodong.HP3" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落四</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p4" name="huodong.HP4" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落五</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p5" name="huodong.HP5" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            ...
            <td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(1)" id="id_img1" src="/LDZX<s:property value="huodong.HPhoto1"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			<td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(2)" id="id_img2" src="/LDZX<s:property value="huodong.HPhoto2"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			<td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(3)" id="id_img3" src="/LDZX<s:property value="huodong.HPhoto3"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			 <td></td>
        ...
        <tr>
            ...
            <td colspan="4">
            	<input type="hidden" name="huodong.HId" value="<s:property value="#huodong.HId"/>"/>
