...
<body>
<form id="updateForm" action="${path}/ajax_a_update" method="post" enctype="multipart/form-data">
	<table class="table table-bordered table-hover definewidth m10"> 
        <tr>
            <td class="tableleft" width="100px">标题</td>
            <td colspan="4">
            	<s:textfield maxlength="25" id="title" name="about.ATitle" type="text" required="true" cssStyle="width:100%"></s:textfield>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落一</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p1" name="about.AP1" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落二</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p2" name="about.AP2" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落三</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p3" name="about.AP3" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落四</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p4" name="about.AP4" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            <td class="tableleft">段落五</td>
            <td colspan="4">
            	<s:textarea maxlength="240" id="p5" name="about.AP5" type="text" required="true" cssStyle="width:100%"></s:textarea>            
            </td>
        </tr>
        <tr>
            ...
            <td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(1)" id="id_img1" src="/LDZX<s:property value="about.APhoto1"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			<td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(2)" id="id_img2" src="/LDZX<s:property value="about.APhoto2"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			<td width="300px">
				...
				<s:else>
					<a href="javascript:void(0);" title="点击上传图片">
						<img onclick="addfile(3)" id="id_img3" src="/LDZX<s:property value="about.APhoto3"/>"  style="width: 300px;height: 200px;">
					</a>
				</s:else>
			</td>
			 <td></td>
        ...
        <tr>
            ...
            <td colspan="4">
            	<input type="hidden" name="about.AId" value="<s:property value="#session.user.UId"/>"/>
		...
		if(issubmit)
		{
			...
			({
				...
				success:function(result)
				{
					...
					{
						alert("修改成功！");
						window.location.href="${path}/about_list";
					}
				}
			});
		}
