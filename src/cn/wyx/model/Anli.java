...
/**
 * Anli entity. @author MyEclipse Persistence Tools
 */

public class Anli implements java.io.Serializable
{
	...
	/** full constructor */
	public Anli(String ATitle, String AAword, String AP1, String AP2,
			String AP3, String AP4, String AP5, String APhoto1, String APhoto2,
			String APhoto3)
	{
		this.ATitle = ATitle;
		this.AAword = AAword;
	...
	public String getAAword()
	{
		return this.AAword;
	}

	public void setAAword(String AAword)
	{
		this.AAword = AAword;
	}
